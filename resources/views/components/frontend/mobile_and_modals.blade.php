            ...
            <div class="row no-gutters bg-white newsletter-popup-content">
                <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                    <div class="banner-content text-center">
                        <img src="{{ asset('frontend/img/logo.jpg') }}" class="logo" alt="logo" width="160" height="50">
                        <h2 class="banner-title">get <span>25<light>%</light></span> off</h2>
                        <p>Subscribe to the JBMM eCommerce newsletter to receive timely updates from your favorite
                            products.</p>
                        <form action="#">
                ...
                <div class="col-xl-2-5col col-lg-5 ">
                    <img src="{{ asset('frontend/img/oak-barrel-4.jpeg') }}" class="newsletter-img" alt="newsletter">
                </div>
            </div>
        </div>
    </div>
