                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <select class="form-select form-control" name="category_id" disabled>
                                    <option selected class="text-capitalize" value="{{ $product->category->id }}" disabled>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" id="Title" class="form-control"
                                    value="{{ ucfirst($product->title) }}" name="title">
                                @error('title')
                                    <span class="text-danger mt-1">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" id="Title" class="form-control"
                                    value="{{ ucfirst($product->name) }}" name="name">
                                @error('name')
                                    <span class="text-danger mt-1">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" id="Title" class="form-control"
                                    value="{{ ucfirst($product->slug) }}" name="slug">
                                @error('slug')
                                    <span class="text-danger mt-1">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea id="" rows="3" name="product_information" class="form-control">{{ ucfirst($product->product_information) }}</textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea id="" rows="3" name="additional_information" class="form-control">{{ ucfirst($product->additional_information) }}</textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea id="" rows="3" name="short_description" class="form-control">{{ ucfirst($product->short_description) }}</textarea>
                                    ...
                                    @foreach ($product->productImages as $image)
                                        ...
                                        <a href="{{ url('admin/product-image/' . $image->id . '/delete') }}"
                                            ...
                                            <i class="fa-solid fa-xmark text-danger"
                                                style="position: absolute; top: 45%"></i>
                                        </a>
                                    @endforeach
                                @else
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="number" min="0" id="Title" class="form-control"
                                    value="{{ ucfirst($product->product_original_price) }}"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="number" id="Title" class="form-control"
                                    value="{{ ucfirst($product->product_quantity) }}" name="product_quantity"
                                    min="0">
                                ...
                                <div class="">
                                    @if ($product->tranding == '0')
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="tranding"
                                                id="visible" value="0" checked>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea id="" rows="3" class="form-control" name="product_meta_description">{{ ucfirst($product->product_meta_description) }}</textarea>
