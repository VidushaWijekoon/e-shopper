                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="Title" class="form-control"
                                value="{{ $product->category->title }}" readonly disabled>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="Title" class="form-control" value="{{ $product->brand->title }}"
                                readonly disabled>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea id="" rows="3" class="form-control" readonly disabled>{{ $product->product_information }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea id="" rows="3" class="form-control" readonly disabled>{{ $product->additional_information }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea id="" rows="3" class="form-control" readonly disabled>{{ $product->short_description }}</textarea>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="number" class="form-control" value="{{ $product->product_selling_price }}"
                                readonly disabled>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="Title" class="form-control"
                                value="{{ $product->product_meta_title }}" name="product_meta_keyword" readonly disabled>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="Title" class="form-control"
                                value="{{ $product->product_meta_keyword }}" name="product_meta_keyword" readonly
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" class="form-control" disabled readonly>{{ $product->product_meta_description }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
