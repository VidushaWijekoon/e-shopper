                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="Title" class="form-control" placeholder="Brand Title" name="name">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="Title" class="form-control" placeholder="Brand Title" name="slug">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="Title" class="form-control" placeholder="Product Meta Title"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="Title" class="form-control" placeholder="Product Meta keywords"
