                    ...
                    <form action="{{ route('admin.slider') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="Title" class="form-control" placeholder="Slider Title"
                                    name="title">
                                @error('title')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="Slug" class="form-control" placeholder="Slider Slug"
                                    name="slug">
                                @error('slug')
                                    <span class="text-danger mt-1">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col md-12">
                                <label for="Slug" class="form-label">Short Description
                                    <span class="text-danger">*</span>
                                </label>
                    ...
                    <div class="table-responsive">
                        @forelse ($sliders as $sliderItems)
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <span>
                                    <img src="{{ asset($sliderItems->image) }}" alt="{{ $sliderItems->title }}"
